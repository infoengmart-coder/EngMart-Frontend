...
export default function AdminBrandsPage() {
  ...
  const resetForm = () => {
    ...
    setLogoFile(null); setLogoPreview(""); setEditing(null); setShowForm(false); setError("");
  };
    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      ...
      <div className="relative mb-4 max-w-md">
        ...
        <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search brands..."
          className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
      </div>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 overflow-hidden border border-slate-100 bg-white"
                        ...
                        {b.logo ? <img src={mediaUrl(b.logo)} alt="" className="w-full h-full object-contain p-1" />
            ...
            <form onSubmit={handleSave} className="p-5 space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-xl border border-dashed border-slate-300 flex items-center justify-center overflow-hidden bg-slate-50 shrink-0">
                  {logoPreview ? <img src={logoPreview} alt="" className="w-full h-full object-contain p-1" /> : <ImagePlus className="w-5 h-5 text-slate-300" />}
                </div>
                <div>
