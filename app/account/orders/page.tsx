...
export default function OrderHistory() {
  const { orders, ordersLoaded } = useAccount()
                ...
                <div className="p-4 flex flex-col md:flex-row md:items-center justify-between gap-6">
                  ...
                  <div className="flex-1 space-y-3">
                    {order.items.slice(0, 2).map((item, idx) => (
                      <div key={idx} className="flex gap-3 items-center">
                        <div className="w-12 h-12 bg-secondary rounded-lg overflow-hidden border border-border shrink-0">
                          <img
                  ...
                  <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center gap-3 border-t md:border-t-0 pt-4 md:pt-0 border-slate-100">
                    ...
                    <Link
                      ...
                      className="btn-secondary text-[11px] font-bold px-4 py-2 hover:bg-primary hover:text-white hover:border-primary transition-colors flex items-center gap-1"
                    >
