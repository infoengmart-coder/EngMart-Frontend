...
export default function SupportInquiriesPage() {
  ...
  // On mobile the detail panel sits below the ticket list — without this,
  // tapping a ticket appears to do nothing because the reply opens off-screen.
  useEffect(() => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!subject.trim() || !message.trim()) {
      setFormError('Please fill out both subject and inquiry message fields.')
      return
    }
    setFormError('')
                    ...
                    >
                      ...
                      <div className="text-right shrink-0 flex items-center gap-3">
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                          ...
                          ticket.status === 'Replied' ? 'bg-[var(--color-info)]/10 text-[var(--color-info)]' :
