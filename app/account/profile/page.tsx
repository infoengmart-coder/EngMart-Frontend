...
export default function ProfilePage() {
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    setProfileError('')
    // Real API save (backend accepts name changes only; email is locked
    // server-side because a self-editable email was an account-takeover vector).
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-white border border-slate-200/85 rounded-3xl p-6 shadow-sm">
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-4">
            ...
            {profileError && (
              <div className="rounded-xl border border-destructive/30 bg-destructive/5 text-destructive text-xs font-bold p-3.5">
                {profileError}
              </div>
            )}
          ...
          <form onSubmit={handleNotifSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              {[
                ...
                { key: 'orderUpdatesSMS', title: 'Order Updates via SMS', desc: 'Receive instant alerts on delivery arrival at Karachi port.' },
                ...
                { key: 'quoteAlerts', title: 'RFQ / Quote Notifications', desc: 'Receive notification when an administrator pricing offer is active.' },
