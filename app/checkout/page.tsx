...
export default function CheckoutPage() {
  ...
  const discountAmount = promoResult?.valid ? parseFloat(promoResult.discount_amount || '0') : 0
        ...
        {orderResult ? (
          ...
          >
            ...
            <div className="max-w-sm mx-auto bg-background rounded-xl border border-border/60 p-4 text-left mb-6 mt-4">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between pt-2 border-t border-border">
                  ...
                  <span className="font-black text-primary text-sm">{formatPrice(parseFloat(orderResult.total))}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link href="/products" className="btn-primary text-xs px-6 py-3">Continue Shopping</Link>
