          ...
          <div className="col-span-2">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-start gap-2 text-sm text-muted-foreground font-semibold leading-relaxed max-w-[240px]">
                <svg className="w-4 h-4 text-primary shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                {SITE.address}
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm font-semibold text-muted-foreground">
              {BRANDS.slice(0, 5).map(brand => (
                <li key={brand.slug}>
                  <Link href={`/brands/${brand.slug}`} className="py-1.5 hover:text-primary transition-colors flex items-center gap-2">
